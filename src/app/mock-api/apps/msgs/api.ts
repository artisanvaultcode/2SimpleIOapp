...
import { labels as labelsData, notes as notesData } from 'app/mock-api/apps/msgs/data';
import { FuseMockApiUtils } from '@fuse/lib/mock-api';

@Injectable({
    providedIn: 'root'
})
export class MsgsMockApi
{
